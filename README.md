...
```bash
   git clone https://github.com/labib108/Foodier-ios-project.git
```
...
For any inquiries, please contact [abubuckkersiddikh@gmail.com](mailto:abubuckkersiddikh@gmail.com)
